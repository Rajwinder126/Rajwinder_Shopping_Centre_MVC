...
namespace Rajwinder_Shopping_Centre_MVC.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public BrandsController(Rajwinder_Shopping_Centre_MVCDatabase context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand_Name,Brand_Status")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
